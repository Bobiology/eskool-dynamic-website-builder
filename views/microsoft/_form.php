...
<div class="microsoft-activities-form">
    ...
    <div class="row">
        <div class="form-group">
            <div class="col-lg-6">
                <?php $items = ['Hackathon'=>'Hackathon','Bootcamp'=>'Bootcamp','Leap Program'=>'Leap Program','Workshops'=>'Workshops','Internship'=>'Internship']; ?>
